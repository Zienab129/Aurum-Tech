...
export function Work({
  ...
  return (
    <>
      <PageIntro
        eyebrow={t('work.pageIntro.eyebrow')}
        title={t('work.pageIntro.title')}
      >
        <p>{t('work.pageIntro.description')}</p>
      </PageIntro>
      ...
      <Testimonial
        ...
        client={{ name: 'Al-Faisal Group', logo: logoMailSmirk }}
      >
        <span dangerouslySetInnerHTML={{ __html: t('work.testimonial') }} />
      </Testimonial>
